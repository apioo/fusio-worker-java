            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.events = new java.util.ArrayList<Event>(_list46.size);
                @org.apache.thrift.annotation.Nullable Event _elem47;
                for (int _i48 = 0; _i48 < _list46.size; ++_i48)
                {
                  _elem47 = new Event();
                  _elem47.read(iprot);
                  struct.events.add(_elem47);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.logs = new java.util.ArrayList<Log>(_list49.size);
                @org.apache.thrift.annotation.Nullable Log _elem50;
                for (int _i51 = 0; _i51 < _list49.size; ++_i51)
                {
                  _elem50 = new Log();
                  _elem50.read(iprot);
                  struct.logs.add(_elem50);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Result struct) throws org.apache.thrift.TException {
      ...
      if (struct.events != null) {
        oprot.writeFieldBegin(EVENTS_FIELD_DESC);
        {
          ...
          for (Event _iter52 : struct.events)
          {
            _iter52.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetEvents()) {
        {
          ...
          for (Event _iter54 : struct.events)
          {
            _iter54.write(oprot);
          }
        }
